...
namespace _365Architect.Demo.Persistence.Configurations
{
    ...
    public class SampleConfig : IEntityTypeConfiguration<Sample>
    {
        public void Configure(EntityTypeBuilder<Sample> builder)
        {
            ...
            builder.Property(x => x.CategoryId).HasColumnName(SampleConst.FIELD_CATEGORYID);

            builder.HasOne(s => s.Category).WithMany(c => c.Samples).HasForeignKey(c => c.CategoryId).OnDelete(DeleteBehavior.SetNull);
